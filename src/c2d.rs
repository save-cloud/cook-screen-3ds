...
extern "C" {
    ...
    fn c2d_raw_load_dsi_icon_from_buffer(buffer: *const c_void) -> *mut c_void;
...
pub fn c2d_load_dsi_icon_from_buffer(buffer: &[u16]) -> C2dImage {
    unsafe {
        C2dImage {
            from_sheet: false,
            ptr: c2d_raw_load_dsi_icon_from_buffer(buffer.as_ptr() as *const c_void),
        }
    }
}
